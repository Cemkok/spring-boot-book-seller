...
//Bazı Bean'ler tanımlayacağımız için @Configuration anotasyonu ekleriz.
@Configuration
//Bu sınıf web güvenliği yapılandırma sınfı olduğunu söyler
@EnableWebSecurity
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        //jwt filter
        //internal>jwt>authentication(username-password)
